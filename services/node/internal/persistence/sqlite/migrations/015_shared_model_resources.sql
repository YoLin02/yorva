...
CREATE TABLE runtime_model_defaults (
...
CREATE TABLE instance_model_bindings (
...
DROP TRIGGER operations_block_runtime_wide_mutation_when_instance_active;
DROP TRIGGER operations_block_instance_mutation_when_runtime_wide_active;
