...
const (
	...
	ErrorBackupSourceChanged          ErrorCode = "BACKUP_SOURCE_CHANGED"
	ErrorBackupSourceUnsafe           ErrorCode = "BACKUP_SOURCE_UNSAFE"
	ErrorBackupSourceIncomplete       ErrorCode = "BACKUP_SOURCE_INCOMPLETE"
	ErrorBackupInsufficientSpace      ErrorCode = "BACKUP_DESTINATION_INSUFFICIENT_SPACE"
	ErrorBackupStagingFailed          ErrorCode = "BACKUP_STAGING_FAILED"
	ErrorBackupEncryptionFailed       ErrorCode = "BACKUP_ENCRYPTION_FAILED"
