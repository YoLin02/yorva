...
const supportedRange = ">=0.20.2 <0.21.0"
...
func isSupportedHermesVersion(value string) bool {
	parsed, err := parseVersionBanner("Hermes Agent v" + strings.TrimSpace(value))
	return err == nil && parsed.supported()
}
