...
// an approved preset. Arbitrary named environment/header values are outside
// the reviewed-preset contract.
...
// MCPManager is the reviewed-preset mutation boundary. Executable paths,
// argv, environment variables, headers, and raw JSON never cross this API.
