...
const english: Messages = {
  ...
  instances: {
    ...
    unsupportedDescription: "Instance management is available when the selected Runtime is supported.",
    ...
    freshnessUnknown: "The latest Runtime query did not succeed. Showing last known rows as unknown, not deleted.",
    ...
    availabilityHint: {
      AVAILABLE: "Present in the latest successful Runtime query. This is not login, model, or process readiness.",
      MISSING: "This instance was deleted. The Yorva identity is retained as a tombstone.",
      UNKNOWN: "The latest Runtime query failed or could not be parsed. Previous rows were not marked deleted.",
    },
    ...
    queryFailed: "Runtime instance query failed. Inventory freshness is unknown.",
    createLabel: "New instance name",
    createDescription: "Create an isolated instance in the selected Runtime.",
    ...
    deleteWarning: "This permanently deletes the selected instance's Runtime data. Yorva keeps its deleted identity. Protected instances cannot be deleted.",
    ...
    clearRecordWarning: "This removes only Yorva's retained instance record and dependent management metadata after the Runtime confirms the instance is still absent. Runtime data and audit history are not deleted.",
    clearRecordRunning: "Checking and clearing…",
    clearRecordFailed: "The record could not be cleared. Refresh the authoritative Runtime state and try again.",
  ...
  management: {
    ...
    runtimeInstancesDescription: "All instances controlled by this Runtime. Open diagnostics to inspect available health and runtime logs.",
    ...
    upgradeDescription: "Compares the current Runtime version with the packaged candidate. Upgrade and rollback controls appear only when a managed version transition is fully available.",
...
const simplifiedChinese: Messages = {
  ...
  instances: {
    ...
    unsupportedDescription: "所选 Runtime 通过支持性检测后，即可管理实例。",
    loading: "正在刷新实例清单",
    refresh: "刷新",
    ...
    lastSynced: "最近一次成功同步",
    freshnessUnknown: "最近一次 Runtime 查询未成功。正在显示上次已知记录，状态为未知，不是已删除。",
    ...
    availabilityHint: {
      AVAILABLE: "最近一次成功的 Runtime 查询确认存在。这不代表已登录、已配置模型或进程已就绪。",
      MISSING: "此实例已删除。Yorva 身份会作为墓碑保留。",
      UNKNOWN: "最近一次 Runtime 查询失败或无法解析。旧记录不会被误判为已删除。",
    },
    ...
    lifecycleConfirm: "继续",
    loadFailure: "无法加载实例。",
    queryFailed: "Runtime 实例查询失败。清单新鲜度为未知。",
    createLabel: "新实例名称",
    createDescription: "在当前 Runtime 中创建一个独立实例。",
    createPlaceholder: "coder",
    createAction: "创建实例",
    createPending: "创建已排队",
    ...
    deleteAction: "删除",
    deleteTitle: "删除实例",
    deleteWarning: "这将永久删除所选实例的 Runtime 数据。Yorva 会保留其已删除身份。受保护实例不可删除。",
    ...
    clearRecordWarning: "Runtime 再次确认该实例仍不存在后，只会清理 YORVA 保留的实例记录及其管理元数据，不会删除 Runtime 数据或审计历史。",
    clearRecordRunning: "正在确认并清理…",
    clearRecordFailed: "未能清理记录。请刷新 Runtime 权威状态后重试。",
    tableInstance: "实例",
  ...
  management: {
    ...
    runtimeInstancesDescription: "此 Runtime 管理的全部实例；可查看各实例支持的健康状态和运行日志。",
    ...
    neverReady: "当前没有就绪证据",
    upgradeTitle: "升级计划",
    upgradeDescription: "比较当前 Runtime 与内置候选版本；仅在确有受管版本变更且完整可执行时显示升级或回滚入口。",
