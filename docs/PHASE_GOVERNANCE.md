...
- historical post-freeze amendment 002A4 compatibility policy: exact `=0.20.2`;
- P6.5 successor ADR-0012 / Amendment 0065A1 policy: stable `>=0.20.2 <0.21.0`, without moving the historical Phase 2 tag;
- formal status: `COMPLETE / FROZEN`;
